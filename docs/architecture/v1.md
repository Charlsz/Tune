...
**Versión:** 1.2  
**Fecha:** 2026-09-15  
**Basado en:** [Primer Informe](../PrimerInforme.md) — sección 5 · [Investigacion.md](../Investigacion.md)
...
|------------|------------|-----------|--------|
| Dataset | Scripts + metadata | `data/`, `infrastructure/data/` | Esqueleto (`prepare_data` TODO) |
...
Ver [ADR 001](../decisions/001-task-selection.md) · [CaminoInmediato.md](../CaminoInmediato.md).
...
- [Propuesta reunión tutor](../decisions/003-propuesta-fase0-tutor.md)
- ADR 003 (Colab/Kaggle → MLflow): redactar tras el primer smoke
